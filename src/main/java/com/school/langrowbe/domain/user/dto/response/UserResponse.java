...
public record UserResponse(
    ...
    @Schema(description = "로그인 아이디", example = "langrow") String loginId,
    ...
    @Schema(description = "작성한 일기 수", example = "0") int diaryCount,
    @Schema(description = "연속 작성 일수", example = "0") int streakCount,
    @Schema(description = "친구 수", example = "0") int friendCount) {}
